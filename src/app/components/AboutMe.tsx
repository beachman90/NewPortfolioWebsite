  ...
  return (
    <section className="py-20 bg-background-light dark:bg-background-dark">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10 text-gray-800 dark:text-text-dark">Om Meg</h2>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 text-center lg:text-left">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-text-dark">Jan Inge Kirsebom Strandman</h3>
          ...
          <div className="lg:col-span-2">
            <Card className="bg-white dark:bg-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-gray-800 dark:text-text-dark">Fra Miljøarbeid til Utvikling</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-800 dark:text-text-dark mb-4">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-text-dark mt-6 mb-2">Min Tekniske Kompetanse</h4>
                <p className="text-gray-800 dark:text-text-dark mb-2">
                  Gjennom intensiv læring har jeg bygget opp solid kunnskap innen moderne utviklingsverktøy:
                </p>
                <ul className="list-disc list-inside text-gray-800 dark:text-text-dark mb-4">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-text-dark mt-6 mb-2">Erfaring Fra To Verdener</h4>
                <p className="text-gray-800 dark:text-text-dark mb-2">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-text-dark mt-6 mb-2">Utenom Jobben</h4>
                <p className="text-gray-800 dark:text-text-dark mb-4">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-text-dark mt-6 mb-2">Hva Jeg Ser Etter</h4>
                <p className="text-gray-800 dark:text-text-dark mb-2">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-text-dark mt-6 mb-2">Til Slutt</h4>
                <p className="text-gray-800 dark:text-text-dark mb-4">
                ...
                <p className="text-gray-800 dark:text-text-dark">
